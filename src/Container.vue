<template>
  <el-container style="height:100%">
    <el-header style="text-align: right;">
      ...
      <a
        href="https://afdian.net/@aliceliveman"
        class="patron"
        target="_black"
      >
        <img
      ...
      <a
        href="https://vtuber.magictea.cc/"
        class="patron"
        target="_black"
      >
        <img
          src="./assets/magictea.png"
          height="54"
        >
      </a>
      <!-- <a href="https://www.vultr.com/?ref=7654882" class="patron" target="_black" ><img src="./assets/vultr.png" height="54"></a> -->
      <el-progress
        v-for="(value, key) in account.billTimeMap"
        :key="key"
        type="circle"
        :width="54"
        :percentage="(60 - (account.timestamp - value) / (60 * 1000)) / 60 * 100"
        status="text"
      >
        <span>
    ...
    <el-container style="background:#333;height: 100%;">
      <el-aside width="200px">
        ...
        >
          ...
          <el-menu-item index="/main/myAccount">
            <svg
              class="svg-icon"
              aria-hidden="true"
              viewBox="0 0 576 512"
      ...
      <el-container direction="vertical">
        ...
        <el-main>
          ...
          <el-footer height="50px">
            <a
              target="_black"
              href="https://github.com/nekoteaparty/Alice-LiveMan"
            >
              <span>Fork on</span>
              <img
                width="18"
            ...
            <div style="position: absolute; top: 17px; right: 26px;">Alice Website © 2018 - 2019 nekoteaparty</div>
          </el-footer>
        </el-main>
      </el-container>
    </el-container>
...
export default {
  ...
  created() {
          ...
          if (response.data.code === 0) {
            ...
            if (this.account.broadcastError) {
              ...
              if (lastError != null) {
                ...
                if (
                  !lastError.isRead ||
                  lastError.errTime != this.account.broadcastError.errTime
                ) {
                  showErrorTip = true;
                }
              } else {
              ...
              if (showErrorTip && !isShowingErrorTip) {
                ...
                this.$alert(
                  <div>
                    您的转播任务因为以下原因，已于{lastError.errTime}
                    (GMT+8)停止:
                    <br />
    ...
    getInfo();
    window.interval = setInterval(getInfo, 2000);
  }
};
</script>
